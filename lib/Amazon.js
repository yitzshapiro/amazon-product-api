...
class AmazonScraper {
    ...
    async startScraper() {
        ...
        const response = {
            ...
            listLength: this.collector.length  // Add the list length here
        };
    ...
    async saveResultToFile() {
        if (this.collector.length) {
            // Add the listLength to each item in the collector
            const listLength = this.collector.length;
            this.collector = this.collector.map(item => ({
                ...item,
                listLength,  // Add the listLength to each item
            }));
